...
const Schema: z.ZodType<Prisma.NestedEnumReceiptTypeNullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const NestedEnumReceiptTypeNullableWithAggregatesFilterObjectSchema =
  Schema;
