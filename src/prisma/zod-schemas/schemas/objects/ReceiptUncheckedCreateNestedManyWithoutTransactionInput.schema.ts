...
const Schema: z.ZodType<Prisma.ReceiptUncheckedCreateNestedManyWithoutTransactionInput> =
  z
    .object({
      create: z
        .union([
...
export const ReceiptUncheckedCreateNestedManyWithoutTransactionInputObjectSchema =
  Schema;
