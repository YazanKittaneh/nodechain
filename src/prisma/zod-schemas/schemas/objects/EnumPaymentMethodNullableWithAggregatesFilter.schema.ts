...
import { NestedEnumPaymentMethodNullableWithAggregatesFilterObjectSchema } from './NestedEnumPaymentMethodNullableWithAggregatesFilter.schema';
...
const Schema: z.ZodType<Prisma.EnumPaymentMethodNullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const EnumPaymentMethodNullableWithAggregatesFilterObjectSchema = Schema;
