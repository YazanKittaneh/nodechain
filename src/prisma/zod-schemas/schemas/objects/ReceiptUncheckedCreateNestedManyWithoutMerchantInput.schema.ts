...
const Schema: z.ZodType<Prisma.ReceiptUncheckedCreateNestedManyWithoutMerchantInput> =
  z
    .object({
      create: z
        .union([
...
export const ReceiptUncheckedCreateNestedManyWithoutMerchantInputObjectSchema =
  Schema;
