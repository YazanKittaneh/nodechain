...
const Schema: z.ZodType<Prisma.ReceiptUncheckedCreateNestedManyWithoutItemsInput> =
  z
    .object({
      create: z
        .union([
...
export const ReceiptUncheckedCreateNestedManyWithoutItemsInputObjectSchema =
  Schema;
