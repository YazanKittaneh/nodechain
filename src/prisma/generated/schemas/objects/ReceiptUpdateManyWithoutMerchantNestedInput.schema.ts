...
const Schema: z.ZodType<Prisma.ReceiptUpdateManyWithoutMerchantNestedInput> = z
  .object({
    create: z
      .union([
...
export const ReceiptUpdateManyWithoutMerchantNestedInputObjectSchema = Schema;
