...
const Schema: z.ZodType<Prisma.ReceiptUpdateManyWithWhereWithoutItemsInput> = z
  .object({
...
export const ReceiptUpdateManyWithWhereWithoutItemsInputObjectSchema = Schema;
