...
const Schema: z.ZodType<Prisma.ReceiptUncheckedCreateWithoutTransactionInput> =
  z
    .object({
...
export const ReceiptUncheckedCreateWithoutTransactionInputObjectSchema = Schema;
