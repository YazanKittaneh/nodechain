...
const Schema: z.ZodType<Prisma.ReceiptUncheckedUpdateManyWithoutTransactionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ReceiptUncheckedUpdateManyWithoutTransactionNestedInputObjectSchema =
  Schema;
