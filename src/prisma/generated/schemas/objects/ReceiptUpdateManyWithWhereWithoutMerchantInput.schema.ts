...
const Schema: z.ZodType<Prisma.ReceiptUpdateManyWithWhereWithoutMerchantInput> =
  z
    .object({
      ...
      data: z.union([
        ...
        z.lazy(
          () => ReceiptUncheckedUpdateManyWithoutReceiptsInputObjectSchema,
        ),
      ]),
    })
    .strict();

export const ReceiptUpdateManyWithWhereWithoutMerchantInputObjectSchema =
  Schema;
