...
const Schema: z.ZodType<Prisma.ReceiptUncheckedUpdateManyWithoutItemsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => ReceiptUpsertWithWhereUniqueWithoutItemsInputObjectSchema,
          ),
          z
            .lazy(
              () => ReceiptUpsertWithWhereUniqueWithoutItemsInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => ReceiptUpdateWithWhereUniqueWithoutItemsInputObjectSchema,
          ),
          z
            .lazy(
              () => ReceiptUpdateWithWhereUniqueWithoutItemsInputObjectSchema,
...
export const ReceiptUncheckedUpdateManyWithoutItemsNestedInputObjectSchema =
  Schema;
